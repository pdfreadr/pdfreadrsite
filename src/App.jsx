  ...
  const darkImages = [
    {
      ...
      src: `${import.meta.env.BASE_URL}DARK_SCREENSHOT_1.png`,
    },
    {
      title: 'Thumbnail browsing',
      text: 'Show navigation or pages in the dark theme.',
      src: `${import.meta.env.BASE_URL}DARK_SCREENSHOT_2.png`,
    },
    {
      title: 'Reading layout',
      text: 'Show a close-up clean reading experience in dark mode.',
      src: `${import.meta.env.BASE_URL}DARK_SCREENSHOT_3.png`,
    },
  ]
        ...
        <header className={`flex flex-wrap items-center justify-between gap-4 border-b ${theme.border} pb-5`}>
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 items-center justify-center">
              <img src={`${import.meta.env.BASE_URL}logo.png`} alt="PDFReader logo" className="h-12 w-12 object-contain" />
            </div>
            <div>
